...
export const ANALYTICS_EVENTS = {
  ...
  diagnostic_intake_started: "diagnostic_intake_started",
  diagnostic_role_selected: "diagnostic_role_selected",
  diagnostic_intake_completed: "diagnostic_intake_completed",
  diagnostic_legacy_wizard_clicked: "diagnostic_legacy_wizard_clicked",
  diagnostic_redirect_triggered: "diagnostic_redirect_triggered",
