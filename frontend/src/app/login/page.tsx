...
/** Allow same-origin paths only for redirect after login. */
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 pb-16 bg-background">
      <div className="w-full max-w-[1300px] flex flex-col md:flex-row min-h-[85vh] md:min-h-[82vh] rounded-[16px] overflow-hidden bg-surface border border-border shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
        ...
        <div className="w-full md:w-[42%] flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-12 md:py-16">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-ink tracking-tight mt-2 mb-2">
            Log in to CLEAR
          </h1>
          ...
          <p className="text-ink-muted text-sm mb-6">
            Use your work email to access your CLEAR workspace.
          </p>

          <form onSubmit={onSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="login-email" className="text-ink font-medium">
                Email address
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    "h-12 pl-10 pr-4 rounded-lg border text-base",
                    errors.email
            ...
            <div className="space-y-2">
              <Label htmlFor="login-password" className="text-ink font-medium">
                Password
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    "h-12 pl-10 pr-24 rounded-lg border text-base",
                    errors.password
                      ? "border-red-500 focus-visible:ring-red-500"
                      : "border-border focus-visible:ring-primary"
                  )}
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-sm font-medium text-ink-muted hover:text-ink focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 rounded px-1"
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-lg text-base font-semibold focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          ...
          <div className="mt-4 space-y-2 text-sm">
            <p className="text-ink-muted">
              <Link
                ...
                className="font-medium hover:underline focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 rounded"
                style={{ color: BRAND_COLOR }}
              >
        ...
        {/* Right: Hero panel ~55–60%; hidden on very small screens for usability */}
        <div
          className="relative hidden sm:flex w-full md:w-[58%] min-h-[40vh] md:min-h-0 flex-col justify-end bg-ink overflow-hidden"
          aria-hidden
        >
          {/* Background: gradient + subtle pattern (no external image required) */}
          <div
            className="absolute inset-0 opacity-90"
            style={{
              background:
                "linear-gradient(135deg, rgba(28, 195, 176, 0.25) 0%, rgba(31, 79, 216, 0.35) 50%, rgba(15, 23, 42, 0.6) 100%)",
            }}
          />
          <div
          ...
          <div
            className="absolute inset-y-0 left-0 w-32 md:w-40 bg-gradient-to-r from-white to-transparent opacity-20 pointer-events-none"
            aria-hidden
          />
          {/* Optional overlay text (subtle) */}
          <div className="relative p-6 md:p-8 text-white/90 max-w-sm">
            ...
            <p className="text-xs text-white/70 mt-1 leading-relaxed">
              Track, forecast, and manage your business finances in one secure workspace.
            </p>
          </div>
        </div>
      </div>
